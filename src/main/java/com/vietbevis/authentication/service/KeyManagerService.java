...
public class KeyManagerService {
    ...
    public void init() {
        try {
            ...
            if (allKeysExist(privateKeyAccessFile, publicKeyAccessFile, privateKeyRefreshFile,
                ...
                generateAndSaveKeyPair(privateKeyAccessFile, publicKeyAccessFile,
        ...
        if (!directory.exists()) {
            if (!directory.mkdirs()) {
                ...
                throw new KeyManagementException(
                        "Không thể tạo thư mục chứa khóa: " + keyDirectory);
            }
    ...
    private void loadKeys(File privateKeyAccessFile, File publicKeyAccessFile,
        ...
        byte[] privateKeyBytes = Files.readAllBytes(
                Paths.get(privateKeyAccessFile.getAbsolutePath()));
        byte[] publicKeyBytes = Files.readAllBytes(
                Paths.get(publicKeyAccessFile.getAbsolutePath()));
        ...
        privateKeyRefresh = keyFactory.generatePrivate(
                new PKCS8EncodedKeySpec(privateKeyRefreshBytes));
